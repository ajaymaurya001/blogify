...
<body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <a href="{{ route('home') }}" class="navbar-brand font-weight-bold text-secondary" style="font-size: 50px">
                <img src="{{ asset('assets/img/blogify-logo.webp') }}" alt="" width="140px">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="" class="nav-link dropdown-toggle @yield('blogs', '')"
                            data-toggle="dropdown">Blogs</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="{{ route('blogs') }}" class="dropdown-item">All Blogs</a>
                            <a href="#" class="dropdown-item">Nature</a>
                            <a href="#" class="dropdown-item">Tourism</a>
                        </div>
                    </div>
                </div>
                @guest
    ...
    <!-- Back to Top -->
    <a href="{{ url('/') }}" class="btn btn-primary p-3 back-to-top"><i class="fa fa-angle-double-up"></i></a>
