                    ...
                    <div class="profile-statistics">
                        <div class="text-center mt-4 border-bottom-1 pb-3">
                            ...
                            <div class="mt-4"><a href="javascript:void()"
                                    class="btn btn-primary pl-5 pr-5 mr-3 mb-4">Follow</a> <a href="javascript:void()"
                                    class="btn btn-dark pl-5 pr-5 mb-4">Send
                                    Message</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="my-post-content pt-3">
                                        <div class="post-input">
                                            <textarea name="textarea" id="textarea" cols="30" rows="5" class="form-control bg-transparent"
                                                placeholder="Please type what you want...."></textarea> <a href="javascript:void()"><i class="ti-clip"></i>
                                            </a>
                                            ...
                                            <form>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-check">
                                                        ...
                                                        <label for="gridCheck" class="form-check-label">Check me
                                                            out</label>
                                                    </div>
                                                </div>
