        ...
        <div class="row pt-5">
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    ...
                    <img class="img-fluid rounded w-50 float-left mr-4 mb-3" src="{{ $defaultImage }}" alt="Image" />
                    <p>
                    ...
                    <img class="img-fluid rounded w-50 float-right ml-4 mb-3" src="{{ $defaultImage }}" alt="Image" />
                    <p>
                        Diam dolor est labore duo invidunt ipsum clita et, sed et lorem
                        voluptua tempor invidunt at est sanctus sanctus. Clita dolores sit
                        kasd diam takimata justo diam lorem sed. Magna amet sed rebum eos.
